...
class TestCommentForm(TestCase):
    ...
    def test_form_is_valid(self):
        ...
        post = Post.objects.create(title='Test Post', slug='test-post', author_id=author.id, content='Test Content')
        
        comment_form = CommentForm({'post': post.id, 'body': 'This is a great post'})
